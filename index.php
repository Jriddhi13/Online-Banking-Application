                ...
                <div class="row">
                  <div class="col-lg-12  ">
                    <div class="our-text">
                      ...
                      <p> Click on the Transfer amount button if you want to transfer money from pre-existing accounts.<br> Click on transactions button to view the previous transactions.</p>
                      <div class="butns">
